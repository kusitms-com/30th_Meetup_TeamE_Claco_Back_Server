...
public class GlobalExceptionHandler {
	...
	public ApiResponse<Void> exceptionHandler(Exception exception) {
		...
		return ApiResponse.fail(ApiStatus.EXCEPTION_OCCUR.getCode(), exception.getMessage());
	}
	...
	public ApiResponse<Void> runtimeExceptionHandler(RuntimeException runtimeException) {
		...
		return ApiResponse.fail(ApiStatus.RUNTIME_EXCEPTION_OCCUR.getCode(), runtimeException.getMessage());
	}
